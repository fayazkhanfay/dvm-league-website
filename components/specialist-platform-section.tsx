    ...
    <section className="py-24 sm:py-32 bg-brand-navy text-brand-offwhite">
      <div className="mx-auto max-w-5xl px-6 lg:px-8 text-center">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-brand-navy/50 p-6 rounded-xl border border-brand-gold/30 animate-fade-in-rise animate-delay-400 hover-lift transition-all duration-300 group">
            <MapPin className="w-10 h-10 text-brand-gold mx-auto transition-all duration-300 group-hover:scale-110 group-hover:text-brand-offwhite" />
          ...
          <div className="bg-brand-navy/50 p-6 rounded-xl border border-brand-gold/30 animate-fade-in-rise animate-delay-400 hover-lift transition-all duration-300 group">
            <DollarSign className="w-10 h-10 text-brand-gold mx-auto transition-all duration-300 group-hover:scale-110 group-hover:text-brand-offwhite" />
            <h3 className="mt-4 text-xl font-bold group-hover:text-brand-gold transition-colors duration-300">
              High-Value Work
            </h3>
            <p className="mt-2 text-sm text-brand-offwhite/70">
          ...
          <div className="bg-brand-navy/50 p-6 rounded-xl border border-brand-gold/30 animate-fade-in-rise animate-delay-400 hover-lift transition-all duration-300 group">
            <CheckCircle className="w-10 h-10 text-brand-gold mx-auto transition-all duration-300 group-hover:scale-110 group-hover:text-brand-offwhite" />
            <h3 className="mt-4 text-xl font-bold group-hover:text-brand-gold transition-colors duration-300">
              Zero Friction
            </h3>
            <p className="mt-2 text-sm text-brand-offwhite/70">
