        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
          ...
          <div className="mt-12 flex flex-col items-center gap-4">
            <Button
              ...
              className="group w-full sm:w-auto rounded-md bg-brand-gold px-12 py-5 text-xl font-bold text-brand-navy shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 relative overflow-hidden border-2 border-brand-gold/20"
            >
